...
public class CategoriaController {
     ...
     * 
     * @param model Usamos esta variable para mandar los datos de las categorias a
     *              la vista.
    ...
    /**
     * Es la funcion que nos llevara a la pagina con el formulario para crear una
     * nueva categoria.
     * 
     * @param model Usamos esta variable para mandar el objeto de la nueva
     *              Categoria.
    ...
    /**
     * Es la funcion que recibira los datos recibidos del formulario rellenado en
     * create.
     * 
     * @param categoria Usamos esta variable para tomar los valores de la nueva
     *                  categoria y almacenaarla.
     * @return Nos redirigira a la vista mencionada en index.
     * 
     */
    @PostMapping("/categorias")
    public String store(@Valid Categoria categoria, BindingResult result) {
        if (result.hasErrors()) {
            return "categoria/create";
        }
    ...
    /**
     * Es la funcion que nos llevara al formulario para actualizar los datos de una
     * Categoria.
     * 
     * @param id    Es el identificador de la Categoria.
     * @param model Usamos esta variable para pasar los datos de la Categoria a
     *              editar.
     ...
     * 
     * @param id        Es el identificador de la Categoria.
     * @param categoria Usamos esta variable para tomar los valores de la categoria
     *                  y almacenaarla.
     * @return Nos redirigira a la vista mencionada en index.
     * 
     */
    @PutMapping("/categorias/{id}")
    public String update(@PathVariable int id, @Valid Categoria categoria, BindingResult result) {
        if (result.hasErrors()) {
            return "categoria/edit";
        }
