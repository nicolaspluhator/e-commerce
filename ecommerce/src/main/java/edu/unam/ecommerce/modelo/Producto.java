...
public class Producto {
    ...
    /**
     * nombreProducto es el nombre del Producto que sera mostrado en la cabecera de la pagina.
     */
    @NotNull
    @Size(max = 40)
    @Column(length = 40)
    ...
    /**
     * descripcionProducto es una descripcion opcional que se puede agregar para brindar mas informacion a los clientes.
     */
    @NotBlank
    @Size(min = 3, max= 255)
    @Column(length = 255)
    ...
    /**
     * estado Representa si el estado se encuentra activo "true" o dado de baja "false".
     */
    ...
    /**
     * updated_at Representa la fecha en la cual se modifico algun valor del Producto.
     */
