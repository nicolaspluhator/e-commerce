...
/**
 * Esta clase es de las Categorias de los Productos que se van a ofrecer en la
 * pagina.
 * 
 * @version v1.0.0.2
...
public class Categoria {
    ...
    /**
     * descripcionCategoria es una descripcion opcional que se puede agregar para
     * brindar mas informacion a los clientes.
     */
    @Size(max = 60, message = "La descripcion no debe ser superior a 60 caracteres")
    ...
    /**
     * updated_at Representa la fecha en la cual se modifico algun valor de la
     * Categoria.
     */
    private LocalDateTime updated_at = LocalDateTime.now();

    /**
     * productos Representa una lista con todos los Productos que pertenecen a la
     * Categoria.
     * 
